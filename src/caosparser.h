...
struct CAOSCommandNode : CAOSNode {
    CAOSCommandNode(std::string name_, ci_type type_, std::vector<CAOSNodePtr> args_) : name(name_), type(type_), args(args_) {}
    std::string name;
    ci_type type;
...
struct CAOSConditionNode : CAOSNode {
    CAOSConditionNode(std::vector<CAOSNodePtr> args_) : args(args_) {}
    std::vector<CAOSNodePtr> args;
};
...
struct CAOSLiteralWordNode : CAOSNode {
    CAOSLiteralWordNode(std::string word_) : word(word_) {}
    std::string word;
};
