...
class genomeFile {
	...
	friend Reader& operator>>(Reader&, genomeFile&);
...
class oldBrainLobeGene : public brainGene {
  ...
  public:
	...
	oldBrainLobeGene(uint8_t v)
		: brainGene(v), dendrite1(v), dendrite2(v) {}
...
class bioInitialConcentrationGene : public bioGene {
  ...
  public:
	...
	bioInitialConcentrationGene(uint8_t v)
		: bioGene(v) {}
...
class creatureStimulusGene : public creatureGene {
  ...
  public:
	...
	creatureStimulusGene(uint8_t v)
		: creatureGene(v) {}
...
class creatureAppearanceGene : public creatureGene {
  ...
  public:
	...
	creatureAppearanceGene(uint8_t v)
		: creatureGene(v) {}
...
class creatureInstinctGene : public creatureGene {
  ...
  public:
	...
	creatureInstinctGene(uint8_t v)
		: creatureGene(v) {}
...
class creaturePigmentBleedGene : public creatureGene {
  ...
  public:
	...
	creaturePigmentBleedGene(uint8_t v)
		: creatureGene(v) {}
...
class creatureFacialExpressionGene : public creatureGene {
  ...
  public:
	...
	creatureFacialExpressionGene(uint8_t v)
		: creatureGene(v) {}
