...
TEST(caos, flow) { run_script("c3", readfile("../tests/flow.cos")); }

TEST(caos, ifblocks) { run_script("c3", readfile("../tests/ifblocks.cos")); }

TEST(caos, parse_comment_end) {
  run_script("c3", readfile("../tests/parse-comment-end.cos"));
}

TEST(caos, parsing) { run_script("c3", readfile("../tests/parsing.cos")); }
...
TEST(caos, strings) { run_script("c3", readfile("../tests/strings.cos")); }
