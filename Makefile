...
openc2e_nofinal_OBJECTS = caosVM_sounds.$(OBJEXT) caosVM_creatures.$(OBJEXT) \
	caosVM_motion.$(OBJEXT) caosVM_scripts.$(OBJEXT) \
	caoshashes.$(OBJEXT) caosVM_compound.$(OBJEXT) \
	caosVM_variables.$(OBJEXT) caosVM_flow.$(OBJEXT) \
	caosdata.$(OBJEXT) caosVM_agent.$(OBJEXT) World.$(OBJEXT) \
...
openc2e.all_cpp.cpp: $(srcdir)/Makefile.in $(srcdir)/caosVM_sounds.cpp $(srcdir)/caosVM_creatures.cpp $(srcdir)/caosVM_motion.cpp $(srcdir)/caosVM_scripts.cpp $(srcdir)/caoshashes.cpp $(srcdir)/caosVM_compound.cpp $(srcdir)/caosVM_variables.cpp $(srcdir)/caosVM_flow.cpp $(srcdir)/caosdata.cpp $(srcdir)/caosVM_agent.cpp $(srcdir)/World.cpp $(srcdir)/Vehicle.cpp $(srcdir)/SimpleAgent.cpp $(srcdir)/Room.cpp $(srcdir)/MetaRoom.cpp $(srcdir)/Map.cpp $(srcdir)/main.cpp $(srcdir)/Creature.cpp $(srcdir)/CompoundAgent.cpp $(srcdir)/caosVM_map.cpp $(srcdir)/caosVM_core.cpp $(srcdir)/caosVM_cmdinfo.cpp $(srcdir)/caosVM_camera.cpp $(srcdir)/caosVM.cpp $(srcdir)/caosScript.cpp $(srcdir)/Camera.cpp $(srcdir)/c16Image.cpp $(srcdir)/blkImage.cpp $(srcdir)/Agent.cpp 
	...
	for file in caosVM_sounds.cpp caosVM_creatures.cpp caosVM_motion.cpp caosVM_scripts.cpp caoshashes.cpp caosVM_compound.cpp caosVM_variables.cpp caosVM_flow.cpp caosdata.cpp caosVM_agent.cpp World.cpp Vehicle.cpp SimpleAgent.cpp Room.cpp MetaRoom.cpp Map.cpp main.cpp Creature.cpp CompoundAgent.cpp caosVM_map.cpp caosVM_core.cpp caosVM_cmdinfo.cpp caosVM_camera.cpp caosVM.cpp caosScript.cpp Camera.cpp c16Image.cpp blkImage.cpp Agent.cpp ; do \
