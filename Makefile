...
am_openc2e_OBJECTS = physics.$(OBJEXT) caosVM_ports.$(OBJEXT) \
	caosVM_vehicles.$(OBJEXT) mngfile.$(OBJEXT) \
	genomeFile.$(OBJEXT) streamutils.$(OBJEXT) \
	caosVM_input.$(OBJEXT) caosVM_debug.$(OBJEXT) \
	SDL_gfxPrimitives.$(OBJEXT) SDLBackend.$(OBJEXT) \
	mmapifstream.$(OBJEXT) Scriptorium.$(OBJEXT) \
	fileSwapper.$(OBJEXT) Catalogue.$(OBJEXT) \
...
openc2e_nofinal_OBJECTS = physics.$(OBJEXT) caosVM_ports.$(OBJEXT) \
	caosVM_vehicles.$(OBJEXT) mngfile.$(OBJEXT) \
	genomeFile.$(OBJEXT) streamutils.$(OBJEXT) \
	caosVM_input.$(OBJEXT) caosVM_debug.$(OBJEXT) \
	SDL_gfxPrimitives.$(OBJEXT) SDLBackend.$(OBJEXT) \
...
#>- 	./$(DEPDIR)/physics.Po ./$(DEPDIR)/pray.Po \
#>- 	./$(DEPDIR)/streamutils.Po
#>+ 73
...
include ./$(DEPDIR)/caosVM_ports.Po
...
include ./$(DEPDIR)/caosVM_vehicles.Po
...
#>+ 4
KDE_DIST=praydumper.cpp unittest.pl SDLMain.m filetests.cpp BUILDING physics.h SDLMain.h test.cos 
