...
headerdeps.png: $(wildcard *.h) $(wildcard *.hpp) mngparser.tab.hpp catalogue.tab.hpp lex.mng.h lex.yy.h catalogue.lex.h
	tools/depgraph.sh $^ > headerdeps.dot
	dot -Tpng -o $@ headerdeps.dot
